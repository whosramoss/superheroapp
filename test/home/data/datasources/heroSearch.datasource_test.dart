...
import 'package:superheroapi/app/home/data/datasources/heroSearch.datasource.dart';
...
void main() {
  var dio = DioMock();
  var datasource = HeroSearchDatasource(dio);

  test('Return SuperHeroModel', () async {
    when(dio.get(any)).thenAnswer(
      (_) async => Response(data: jsonDecode(jsonResponse), statusCode: 200),
    );

    var result = await datasource.searchText("batman");
