...
import 'package:superheroapi/app/app.module.dart';
import 'package:superheroapi/app/home/presenter/states/search_state.dart';
import 'package:superheroapi/app/home/presenter/stores/search_store.dart';
...
void main() {
  ...
  test('Return [SuccessState]', () async {
    var store = Modular.get<SearchStore>();
    var result = await store.doHeroSearch("text");
    expect(result, isA<SuccessState>());
  });

  test('Change actual state to [SuccessState]', () async {
    var store = Modular.get<SearchStore>();
